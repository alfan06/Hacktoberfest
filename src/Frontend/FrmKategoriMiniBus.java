...
public class FrmKategoriMiniBus extends javax.swing.JFrame {
    ...
    public void tampilkanData(){
        ...
        ArrayList<KategoriMiniBus> list = new KategoriMiniBus().getAll();
        Object rowData[] = new Object[3];
        
        tblKategori.setModel(new DefaultTableModel(new Object[][] {}, kolom));
        
        for(KategoriMiniBus kat : list){
    ...
    public void cari(String keyword){
        String[] kolom = {"ID", "Nama", "Keterangan"};
        ArrayList<KategoriMiniBus> list = new KategoriMiniBus().search(keyword);
        Object rowData[] = new Object[3];
    ...
    private void btnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnHapusActionPerformed
        ...
        KategoriMiniBus kat = new KategoriMiniBus().getById(Integer.parseInt(model.getValueAt(row, 0).toString()));
        kat.delete();
        kosongkanForm();
        tampilkanData();
